...
<div id="side">
		<div id="myInfo">
			...
			<sec:authorize access="isAuthenticated()">
				...
				<img id="img" src="${pageContext.request.contextPath}/member/photo/${sec_m_id}.jpg" onerror="this.src='${pageContext.request.contextPath}/member/photo/default.jpg'" style="width: 50px; height: 50px"/>			
			</sec:authorize>
			</div>
			<div id="text">
					<div style="font-size: 15px;">안녕하세요!</div>
					<b style="font-size: 1.5rem;">${m_name } ${pt_name }님</b> <br>
